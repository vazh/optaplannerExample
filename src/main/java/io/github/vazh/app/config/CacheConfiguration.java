package io.github.vazh.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(io.github.vazh.app.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(io.github.vazh.app.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
